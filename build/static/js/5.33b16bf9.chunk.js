/*! For license information please see 5.33b16bf9.chunk.js.LICENSE.txt */
    ...
    465: function (A, e, t) {
      A.exports = (function () {
        ...
        var w,
          ...
          I = function (A) {
            var e = U(A),
              t = Array.isArray(e) ? C(e) : new Uint32Array(e),
              r = Array.isArray(e) ? l(e) : new Uint16Array(e),
              n = 24,
              B = N(r, n / 2, t[4] / 2),
              s =
                2 === t[5]
                  ? N(r, (n + t[4]) / 2)
                  : K(t, Math.ceil((n + t[4]) / 4));
            return new T(t[0], t[1], t[2], t[3], B, s);
          },
          T = (function () {
              ...
              (A.prototype.get = function (A) {
                ...
                if (A >= 0) {
                  if (A < 55296 || (A > 56319 && A <= 65535))
                    return (
                      (e = ((e = this.index[A >> g]) << F) + (A & H)),
                      this.data[e]
                    );
                  if (A <= 65535)
                    return (
                      (e =
                        ((e = this.index[h + ((A - 55296) >> g)]) << F) +
                        (A & H)),
                      this.data[e]
                    );
                  if (A < this.highStart)
          ...
          mA = function (A, e) {
            ...
            return (
              A.forEach(function (A, B) {
                var s = HA.get(A);
                if (
                  (s > m ? (n.push(!0), (s -= m)) : n.push(!1),
                  -1 !== ["normal", "auto", "loose"].indexOf(e) &&
                    -1 !== [8208, 8211, 12316, 12448].indexOf(A))
                )
                  return r.push(B), t.push(X);
                if (s === D || s === _) {
                  if (0 === B) return r.push(B), t.push(nA);
                  var o = t[B - 1];
                  return -1 === KA.indexOf(o)
          ...
          OA = function (A, e, t, r, n) {
            if (0 === t[r]) return FA;
            var B = r - 1;
            if (Array.isArray(n) && !0 === n[B]) return FA;
            var s = B - 1,
              o = B + 1,
              i = e[B],
              a = s >= 0 ? e[s] : 0,
              c = e[o];
            if (i === L && c === O) return FA;
            if (-1 !== fA.indexOf(i)) return EA;
            if (-1 !== fA.indexOf(c)) return FA;
            if (-1 !== pA.indexOf(c)) return FA;
            if (LA(B, e) === S) return hA;
            if (HA.get(A[B]) === _ && (c === QA || c === sA || c === oA))
              return FA;
            if (i === b || c === b) return FA;
            if (i === M) return FA;
            if (-1 === [y, x, z].indexOf(i) && c === M) return FA;
            if (-1 !== [J, G, k, j, tA].indexOf(c)) return FA;
            if (LA(B, e) === q) return FA;
            if (RA(Z, q, B, e)) return FA;
            if (RA([J, G], Y, B, e)) return FA;
            if (RA(P, P, B, e)) return FA;
            if (i === y) return hA;
            if (i === Z || c === Z) return FA;
            if (c === X || i === X) return hA;
            if (-1 !== [x, z, Y].indexOf(c) || i === V) return FA;
            if (a === cA && -1 !== TA.indexOf(i)) return FA;
            if (i === tA && c === cA) return FA;
            if (c === W && -1 !== dA.concat(W, k, $, QA, sA, oA).indexOf(i))
              return FA;
            if (
              (-1 !== dA.indexOf(c) && i === $) ||
              (-1 !== dA.indexOf(i) && c === $)
              ...
              return FA;
            if (
              (i === eA && -1 !== [QA, sA, oA].indexOf(c)) ||
              (-1 !== [QA, sA, oA].indexOf(i) && c === AA)
            )
              return FA;
            if (
              (-1 !== dA.indexOf(i) && -1 !== NA.indexOf(c)) ||
              (-1 !== NA.indexOf(i) && -1 !== dA.indexOf(c))
            )
              return FA;
            if (
              (-1 !== [eA, AA].indexOf(i) &&
                (c === $ || (-1 !== [q, z].indexOf(c) && e[o + 1] === $))) ||
              (-1 !== [q, z].indexOf(i) && c === $) ||
              (i === $ && -1 !== [$, tA, j].indexOf(c))
            )
              return FA;
            if (-1 !== [$, tA, j, J, G].indexOf(c))
              for (var Q = B; Q >= 0; ) {
                if ((u = e[Q]) === $) return FA;
                if (-1 === [tA, j].indexOf(u)) break;
                Q--;
              }
            if (-1 !== [eA, AA].indexOf(c))
              for (Q = -1 !== [J, G].indexOf(i) ? s : B; Q >= 0; ) {
                var u;
                if ((u = e[Q]) === $) return FA;
                if (-1 === [tA, j].indexOf(u)) break;
                Q--;
            ...
            if (
              (uA === i && -1 !== [uA, wA, iA, aA].indexOf(c)) ||
              (-1 !== [wA, iA].indexOf(i) && -1 !== [wA, UA].indexOf(c)) ||
              (-1 !== [UA, aA].indexOf(i) && c === UA)
            )
              return FA;
            if (
              (-1 !== IA.indexOf(i) && -1 !== [W, AA].indexOf(c)) ||
              (-1 !== IA.indexOf(c) && i === eA)
            )
              return FA;
            if (-1 !== dA.indexOf(i) && -1 !== dA.indexOf(c)) return FA;
            if (i === j && -1 !== dA.indexOf(c)) return FA;
            if (
              (-1 !== dA.concat($).indexOf(i) && c === q) ||
              (-1 !== dA.concat($).indexOf(c) && i === G)
            )
              return FA;
            if (i === lA && c === lA) {
              for (var w = t[B], U = 1; w > 0 && e[--w] === lA; ) U++;
              if (U % 2 !== 0) return FA;
            }
            return i === sA && c === oA ? FA : hA;
          },
          DA = function (A, e) {
            e || (e = { lineBreak: "normal", wordBreak: "normal" });
            var t = mA(A, e.lineBreak),
              r = t[0],
              n = t[1],
              B = t[2];
            return (
          ...
          bA = function (A, e) {
            ...
            return {
              next: function () {
                ...
                for (var A = FA; c < o && (A = OA(t, B, n, ++c, s)) === FA; );
                if (A !== FA || c === o) {
                  var e = new vA(t, A, a, c);
        ...
        var SA = 1,
          ...
          xe = function (A) {
            return _e(A) || (A >= ve && A <= Se) || (A >= me && A <= Le);
          },
          Ve = function (A) {
            return A >= me && A <= De;
          },
          ...
          Ge = function (A) {
            return A === PA || A === zA || A === XA;
          },
          ke = function (A) {
            return Xe(A) || Je(A) || A === $A;
          },
          We = function (A) {
            return ke(A) || _e(A) || A === Ae;
          },
          Ye = function (A) {
            return (
              (A >= He && A <= de) ||
          ...
          $e = function (A) {
            var e = 0,
              t = 1;
            (A[e] !== Ce && A[e] !== Ae) || (A[e] === Ae && (t = -1), e++);
            for (var r = []; _e(A[e]); ) r.push(A[e++]);
            var n = r.length ? parseInt(a.apply(void 0, r), 10) : 0;
            A[e] === he && e++;
            for (var B = []; _e(A[e]); ) B.push(A[e++]);
            var s = B.length,
              o = s ? parseInt(a.apply(void 0, B), 10) : 0;
            (A[e] !== be && A[e] !== Re) || e++;
            var i = 1;
            (A[e] !== Ce && A[e] !== Ae) || (A[e] === Ae && (i = -1), e++);
            for (var c = []; _e(A[e]); ) c.push(A[e++]);
            var Q = c.length ? parseInt(a.apply(void 0, c), 10) : 0;
            return t * (n + o * Math.pow(10, -s)) * Math.pow(10, i * Q);
          },
          At = { type: w.LEFT_PARENTHESIS_TOKEN },
          et = { type: w.RIGHT_PARENTHESIS_TOKEN },
          tt = { type: w.COMMA_TOKEN },
          rt = { type: w.SUFFIX_MATCH_TOKEN },
          nt = { type: w.PREFIX_MATCH_TOKEN },
          Bt = { type: w.COLUMN_TOKEN },
          st = { type: w.DASH_MATCH_TOKEN },
          ot = { type: w.INCLUDE_MATCH_TOKEN },
          it = { type: w.LEFT_CURLY_BRACKET_TOKEN },
          at = { type: w.RIGHT_CURLY_BRACKET_TOKEN },
          ct = { type: w.SUBSTRING_MATCH_TOKEN },
          Qt = { type: w.BAD_URL_TOKEN },
          ut = { type: w.BAD_STRING_TOKEN },
          wt = { type: w.CDO_TOKEN },
          Ut = { type: w.CDC_TOKEN },
          lt = { type: w.COLON_TOKEN },
          Ct = { type: w.SEMICOLON_TOKEN },
          gt = { type: w.LEFT_SQUARE_BRACKET_TOKEN },
          Et = { type: w.RIGHT_SQUARE_BRACKET_TOKEN },
          Ft = { type: w.WHITESPACE_TOKEN },
          ht = { type: w.EOF_TOKEN },
          Ht = (function () {
            function A() {
              this._value = [];
            ...
            return (
              ...
              (A.prototype.consumeToken = function () {
                ...
                switch (A) {
                  ...
                  case kA:
                    ...
                    if (We(e) || qe(t, r)) {
                      var n = Ze(e, t, r) ? MA : SA,
                        B = this.consumeName();
                      return { type: w.HASH_TOKEN, value: B, flags: n };
                    }
                    break;
                  case WA:
                    ...
                    break;
                  case qA:
                    return this.consumeStringToken(qA);
                  case ZA:
                    return At;
                  case jA:
                    return et;
                  case le:
                    ...
                    break;
                  case Ce:
                    if (je(A, this.peekCodePoint(0), this.peekCodePoint(1)))
                      return (
                  ...
                  case Ae:
                    ...
                    if (o === Ae && i === re)
                      return (
                        this.consumeCodePoint(), this.consumeCodePoint(), Ut
                      );
                    break;
                  case he:
                    if (je(A, this.peekCodePoint(0), this.peekCodePoint(1)))
                  ...
                  case xA:
                    if (this.peekCodePoint(0) === le)
                      for (this.consumeCodePoint(); ; ) {
                        ...
                        if (c === le && (c = this.consumeCodePoint()) === xA)
                          return this.consumeToken();
                        if (c === Ie) return this.consumeToken();
                      }
                    break;
                  case Ee:
                    return lt;
                  ...
                  case te:
                    if (
                      ...
                      return (
                        this.consumeCodePoint(), this.consumeCodePoint(), wt
                      );
                    break;
                  case ne:
                    ...
                    if (Ze(Q, u, U))
                      return (
                        (B = this.consumeName()),
                        { type: w.AT_KEYWORD_TOKEN, value: B }
                      );
                    break;
                  case Be:
                    return gt;
                  case VA:
                    if (qe(A, this.peekCodePoint(0)))
                      return (
                        this.reconsumeCodePoint(A), this.consumeIdentLikeToken()
                      );
                    break;
                  ...
                  case Qe:
                    if (this.peekCodePoint(0) === GA)
                      return this.consumeCodePoint(), st;
                ...
                return Ge(A)
                  ? (this.consumeWhiteSpace(), Ft)
                  : _e(A)
                  ? (this.reconsumeCodePoint(A), this.consumeNumericToken())
                  : ke(A)
                  ? (this.reconsumeCodePoint(A), this.consumeIdentLikeToken())
                  : { type: w.DELIM_TOKEN, value: a(A) };
              }),
              ...
              (A.prototype.consumeUnicodeRangeToken = function () {
                ...
                if (t) {
                  ...
                  return { type: w.UNICODE_RANGE_TOKEN, start: r, end: n };
                }
                var B = parseInt(a.apply(void 0, A), 16);
                if (this.peekCodePoint(0) === Ae && xe(this.peekCodePoint(1))) {
                  this.consumeCodePoint(), (e = this.consumeCodePoint());
                  for (var s = []; xe(e) && s.length < 6; )
                    s.push(e), (e = this.consumeCodePoint());
                  return (
                    (n = parseInt(a.apply(void 0, s), 16)),
                    { type: w.UNICODE_RANGE_TOKEN, start: B, end: n }
                  );
                }
                return { type: w.UNICODE_RANGE_TOKEN, start: B, end: B };
              }),
              (A.prototype.consumeIdentLikeToken = function () {
                var A = this.consumeName();
                return "url" === A.toLowerCase() && this.peekCodePoint(0) === ZA
                  ? (this.consumeCodePoint(), this.consumeUrlToken())
                  : this.peekCodePoint(0) === ZA
                  ? (this.consumeCodePoint(),
                    { type: w.FUNCTION_TOKEN, value: A })
                  : { type: w.IDENT_TOKEN, value: A };
              }),
              (A.prototype.consumeUrlToken = function () {
                var A = [];
                if ((this.consumeWhiteSpace(), this.peekCodePoint(0) === Ie))
                  return { type: w.URL_TOKEN, value: "" };
                var e = this.peekCodePoint(0);
                if (e === qA || e === JA) {
                  var t = this.consumeStringToken(this.consumeCodePoint());
                  return t.type === w.STRING_TOKEN &&
                    (this.consumeWhiteSpace(),
                    this.peekCodePoint(0) === Ie ||
                      this.peekCodePoint(0) === jA)
                    ? (this.consumeCodePoint(),
                      { type: w.URL_TOKEN, value: t.value })
                    : (this.consumeBadUrlRemnants(), Qt);
                }
                for (;;) {
                  var r = this.consumeCodePoint();
                  if (r === Ie || r === jA)
                    return { type: w.URL_TOKEN, value: a.apply(void 0, A) };
                  if (Ge(r))
                    return (
                      this.consumeWhiteSpace(),
                      this.peekCodePoint(0) === Ie ||
                      this.peekCodePoint(0) === jA
                        ? (this.consumeCodePoint(),
                          { type: w.URL_TOKEN, value: a.apply(void 0, A) })
                        : (this.consumeBadUrlRemnants(), Qt)
                    );
                  if (r === JA || r === qA || r === ZA || Ye(r))
                    return this.consumeBadUrlRemnants(), Qt;
                  if (r === VA) {
                    if (!qe(r, this.peekCodePoint(0)))
                      return this.consumeBadUrlRemnants(), Qt;
              ...
              (A.prototype.consumeStringSlice = function (A) {
                for (var e = 6e4, t = ""; A > 0; ) {
                  var r = Math.min(e, A);
                  (t += a.apply(void 0, this._value.splice(0, r))), (A -= r);
                }
              ...
              (A.prototype.consumeStringToken = function (A) {
                for (var e = "", t = 0; ; ) {
                  var r = this._value[t];
                  if (r === Ie || void 0 === r || r === A)
                    return (
                      (e += this.consumeStringSlice(t)),
                      { type: w.STRING_TOKEN, value: e }
                    );
                  if (r === PA) return this._value.splice(0, t), ut;
                  if (r === VA) {
              ...
              (A.prototype.consumeNumber = function () {
                ...
                for (
                  (t !== Ce && t !== Ae) || A.push(this.consumeCodePoint());
                  _e(this.peekCodePoint(0));
              ...
              (A.prototype.consumeNumericToken = function () {
                ...
                return r === YA
                  ? (this.consumeCodePoint(),
                    { type: w.PERCENTAGE_TOKEN, number: e, flags: t })
                  : { type: w.NUMBER_TOKEN, number: e, flags: t };
              }),
              (A.prototype.consumeEscapedCodePoint = function () {
                ...
                if (xe(A)) {
                  ...
                  var t = parseInt(e, 16);
                  return 0 === t || Pe(t) || t > 1114111 ? Ue : t;
                }
                return A === Ie ? Ue : A;
              }),
          ...
          dt = (function () {
            ...
            return (
              ...
              (A.prototype.parseComponentValue = function () {
                ...
                do {
                  A = this.consumeToken();
                } while (A.type === w.WHITESPACE_TOKEN);
                if (A.type === w.EOF_TOKEN) return e;
                throw new SyntaxError(
              ...
              (A.prototype.parseComponentValues = function () {
                for (var A = []; ; ) {
                  var e = this.consumeComponentValue();
                  if (e.type === w.EOF_TOKEN) return A;
                  A.push(e), A.push();
                }
              }),
              (A.prototype.consumeComponentValue = function () {
                var A = this.consumeToken();
                switch (A.type) {
                  case w.LEFT_CURLY_BRACKET_TOKEN:
                  case w.LEFT_SQUARE_BRACKET_TOKEN:
                  case w.LEFT_PARENTHESIS_TOKEN:
                    return this.consumeSimpleBlock(A.type);
                  case w.FUNCTION_TOKEN:
              ...
              (A.prototype.consumeSimpleBlock = function (A) {
                for (
                  ...
                  if (t.type === w.EOF_TOKEN || Lt(t, A)) return e;
              ...
              (A.prototype.consumeFunction = function (A) {
                for (
                  var e = { name: A.value, values: [], type: w.FUNCTION };
                  ;
                  ...
                  if (
                    t.type === w.EOF_TOKEN ||
                    t.type === w.RIGHT_PARENTHESIS_TOKEN
                  )
                    return e;
                  this.reconsumeToken(t),
                    e.values.push(this.consumeComponentValue());
          ...
          ft = function (A) {
            return A.type === w.DIMENSION_TOKEN;
          },
          pt = function (A) {
            return A.type === w.NUMBER_TOKEN;
          },
          Nt = function (A) {
            return A.type === w.IDENT_TOKEN;
          },
          Kt = function (A) {
            return A.type === w.STRING_TOKEN;
          },
          It = function (A, e) {
            return Nt(A) && A.value === e;
          },
          Tt = function (A) {
            return A.type !== w.WHITESPACE_TOKEN;
          },
          mt = function (A) {
            return A.type !== w.WHITESPACE_TOKEN && A.type !== w.COMMA_TOKEN;
          },
          Rt = function (A) {
            var e = [],
              t = [];
            return (
              A.forEach(function (A) {
                ...
                A.type !== w.WHITESPACE_TOKEN && t.push(A);
              }),
              t.length && e.push(t),
              e
            );
          ...
          Lt = function (A, e) {
            return (
              (e === w.LEFT_CURLY_BRACKET_TOKEN &&
                A.type === w.RIGHT_CURLY_BRACKET_TOKEN) ||
              (e === w.LEFT_SQUARE_BRACKET_TOKEN &&
                A.type === w.RIGHT_SQUARE_BRACKET_TOKEN) ||
              (e === w.LEFT_PARENTHESIS_TOKEN &&
                A.type === w.RIGHT_PARENTHESIS_TOKEN)
            );
          },
          Ot = function (A) {
            return A.type === w.NUMBER_TOKEN || A.type === w.DIMENSION_TOKEN;
          },
          Dt = function (A) {
            return A.type === w.PERCENTAGE_TOKEN || Ot(A);
          },
          vt = function (A) {
            return A.length > 1 ? [A[0], A[1]] : [A[0]];
          },
          bt = { type: w.NUMBER_TOKEN, number: 0, flags: yA },
          St = { type: w.PERCENTAGE_TOKEN, number: 50, flags: yA },
          Mt = { type: w.PERCENTAGE_TOKEN, number: 100, flags: yA },
          yt = function (A, e, t) {
            var r = A[0],
              n = A[1];
            return [_t(r, e), _t("undefined" !== typeof n ? n : r, t)];
          },
          _t = function (A, e) {
            if (A.type === w.PERCENTAGE_TOKEN) return (A.number / 100) * e;
            if (ft(A))
              switch (A.unit) {
                case "rem":
                case "em":
          ...
          Jt = function (A) {
            return (
              A.type === w.DIMENSION_TOKEN &&
              (A.unit === Pt || A.unit === xt || A.unit === Vt || A.unit === zt)
            );
          },
          Gt = function (A) {
            switch (
          ...
          Wt = {
            ...
            parse: function (A) {
              ...
              if (A.type === w.HASH_TOKEN) {
                ...
                if (6 === A.value.length)
                  return (
                    ...
                    Zt(parseInt(t, 16), parseInt(r, 16), parseInt(n, 16), 1)
                  );
                if (8 === A.value.length)
                  return (
                    (t = A.value.substring(0, 2)),
              ...
              if (A.type === w.IDENT_TOKEN) {
                var s = Br[A.value.toUpperCase()];
          ...
          jt = function (A, e) {
            if (A.type === w.NUMBER_TOKEN) return A.number;
            if (A.type === w.PERCENTAGE_TOKEN) {
              var t = 3 === e ? 1 : 255;
              return 3 === e
                ? (A.number / 100) * t
        ...
        var er,
          ...
          rr = function (A) {
            var e = A.filter(mt),
              ...
              B = e[3],
              s =
                (t.type === w.NUMBER_TOKEN ? kt(t.number) : Xt.parse(t)) /
                (2 * Math.PI),
              o = Dt(r) ? r.number / 100 : 0,
              i = Dt(n) ? n.number / 100 : 0,
              a = "undefined" !== typeof B && Dt(B) ? _t(B, 1) : 1;
            if (0 === o) return Zt(255 * i, 255 * i, 255 * i, 1);
            var c = i <= 0.5 ? i * (o + 1) : i + o - i * o,
              Q = 2 * i - c,
              u = Ar(Q, c, s + 1 / 3),
              U = Ar(Q, c, s),
              l = Ar(Q, c, s - 1 / 3);
            return Zt(255 * u, 255 * U, 255 * l, a);
          },
          nr = { hsl: rr, hsla: rr, rgb: $t, rgba: $t },
          Br = {
        ...
        var sr,
            ...
            parse: function (A) {
              return A.map(function (A) {
                if (Nt(A))
                  switch (A.value) {
                    case "padding-box":
                      return tr.PADDING_BOX;
                    case "content-box":
                      return tr.CONTENT_BOX;
                  }
                return tr.BORDER_BOX;
              });
            },
          },
          ir = {
          ...
          cr = function (A, e) {
            var t = A[0],
              r = A[A.length - 1];
            null === t.stop && (t.stop = bt), null === r.stop && (r.stop = Mt);
          ...
          lr = function (A, e, t, r, n) {
            var B = 0,
              s = 0;
            switch (A.size) {
              case qr.CLOSEST_SIDE:
                A.shape === Yr.CIRCLE
                  ? (B = s = Math.min(
                      Math.abs(e),
                      Math.abs(e - r),
                  ...
                  : A.shape === Yr.ELLIPSE &&
                    ((B = Math.min(Math.abs(e), Math.abs(e - r))),
                    (s = Math.min(Math.abs(t), Math.abs(t - n))));
                break;
              case qr.CLOSEST_CORNER:
              ...
              case qr.FARTHEST_SIDE:
                A.shape === Yr.CIRCLE
                  ...
                  : A.shape === Yr.ELLIPSE &&
                    ((B = Math.max(Math.abs(e), Math.abs(e - r))),
                    (s = Math.max(Math.abs(t), Math.abs(t - n))));
                break;
              case qr.FARTHEST_CORNER:
                if (A.shape === Yr.CIRCLE)
                  B = s = Math.max(
                    wr(e, t),
                    wr(e, t - n),
            ...
            return (
              Array.isArray(A.size) &&
                ((B = _t(A.size[0], r)),
                (s = 2 === A.size.length ? _t(A.size[1], n) : B)),
              [B, s]
            );
          },
          Cr = function (A) {
            var e = kt(180),
              t = [];
            return (
              Rt(A).forEach(function (A, r) {
                if (0 === r) {
                  var n = A[0];
                  if (n.type === w.IDENT_TOKEN && "to" === n.value)
                    return void (e = Gt(A));
                  if (Jt(n)) return void (e = Xt.parse(n));
                }
                var B = ar(A);
                t.push(B);
              }),
              { angle: e, stops: t, type: sr.LINEAR_GRADIENT }
            );
          },
          gr = function (A) {
            var e = kt(180),
            ...
            return (
              Rt(A).forEach(function (A, r) {
                if (0 === r) {
                  var n = A[0];
                  if (
                    n.type === w.IDENT_TOKEN &&
                    -1 !== ["top", "left", "right", "bottom"].indexOf(n.value)
                  )
                    return void (e = Gt(A));
                  if (Jt(n))
                    return void (e = (Xt.parse(n) + kt(270)) % kt(360));
                }
                var B = ar(A);
                t.push(B);
              }),
              ...
              Nr(s)
                .then(function (e) {
                  ...
                  return (
                    ...
                    (s.style.height = t + "px"),
                    dr(n) ? Nr(pr(t, t, 0, 0, s)) : Promise.reject(!1)
                  );
                })
                .then(function (A) {
                  return (
                    r.drawImage(A, 0, 0), dr(r.getImageData(0, 0, t, t).data)
                  );
                })
                .catch(function () {
                  return !1;
          ...
          Kr = {
            get SUPPORT_RANGE_BOUNDS() {
              var A = Er(document);
              return (
                Object.defineProperty(Kr, "SUPPORT_RANGE_BOUNDS", { value: A }),
                A
              );
            },
            get SUPPORT_SVG_DRAWING() {
              var A = Hr(document);
              return (
                Object.defineProperty(Kr, "SUPPORT_SVG_DRAWING", { value: A }),
                A
              );
            },
            ...
            get SUPPORT_CORS_IMAGES() {
              var A = Fr();
              return (
                Object.defineProperty(Kr, "SUPPORT_CORS_IMAGES", { value: A }),
                A
              );
            },
            ...
            get SUPPORT_CORS_XHR() {
              ...
              return (
                Object.defineProperty(Kr, "SUPPORT_CORS_XHR", { value: A }), A
              );
            },
          },
          Ir = (function () {
            ...
            return (
                          ...
                          [
                            ...
                            new Promise(function (A, e) {
                              ...
                              (r.onload = function () {
                                ...
                                (r.onerror = e),
                                (br(B) || t) && (r.crossOrigin = "anonymous"),
                                (r.src = B),
                                !0 === r.complete &&
                                  setTimeout(function () {
                                    return A(r);
              ...
              (A.prototype.proxy = function (A) {
                ...
                return new Promise(function (n, B) {
                  var s = Kr.SUPPORT_RESPONSE_TYPE ? "blob" : "text",
          ...
          Rr = /^data:image\/svg\+xml/i,
          Lr = /^data:image\/.*;base64,/i,
          Or = /^data:image\/.*/i,
          Dr = function (A) {
            return Kr.SUPPORT_SVG_DRAWING || !Mr(A);
          },
          vr = function (A) {
            return Or.test(A);
          },
          ...
          Mr = function (A) {
            return "svg" === A.substr(-3).toLowerCase() || Rr.test(A);
          },
          yr = function (A) {
            var e = kt(180),
              t = [],
              r = sr.LINEAR_GRADIENT,
              n = Yr.CIRCLE,
              B = qr.FARTHEST_CORNER,
              s = [];
            return (
              Rt(A).forEach(function (A, e) {
                var n = A[0];
                if (0 === e) {
                  if (Nt(n) && "linear" === n.value)
                    return void (r = sr.LINEAR_GRADIENT);
                  if (Nt(n) && "radial" === n.value)
                    return void (r = sr.RADIAL_GRADIENT);
                }
                if (n.type === w.FUNCTION)
                  if ("from" === n.name) {
                    var B = Wt.parse(n.values[0]);
                    t.push({ stop: bt, color: B });
                  } else if ("to" === n.name)
                    (B = Wt.parse(n.values[0])), t.push({ stop: Mt, color: B });
                  else if ("color-stop" === n.name) {
                    var s = n.values.filter(mt);
                    if (2 === s.length) {
                      B = Wt.parse(s[1]);
                      var o = s[0];
                      pt(o) &&
              ...
              r === sr.LINEAR_GRADIENT
                ? { angle: (e + kt(180)) % kt(360), stops: t, type: r }
                : { size: B, shape: n, stops: t, position: s, type: r }
            );
          },
          _r = "closest-side",
          Pr = "farthest-side",
                ...
                if (0 === B) {
                  ...
                  s = A.reduce(function (A, r) {
                    if (o)
                      ...
                      else (Dt(r) || Ot(r)) && n.push(r);
                    else if (Nt(r))
                      switch (r.value) {
                        case zr:
                          return (e = Yr.CIRCLE), !1;
                        case Xr:
                          return (e = Yr.ELLIPSE), !1;
                        case "at":
                          return (o = !0), !1;
                        case _r:
                          return (t = qr.CLOSEST_SIDE), !1;
                        case Jr:
                        case Pr:
                          return (t = qr.FARTHEST_SIDE), !1;
                        case Gr:
                        case xr:
                          return (t = qr.CLOSEST_CORNER), !1;
                        case Vr:
                          return (t = qr.FARTHEST_CORNER), !1;
                      }
                    else if (Ot(r) || Dt(r))
                ...
                if (
                  (0 === B
                    ? (s = A.reduce(function (A, e) {
                        ...
                        else if (Dt(e) || Ot(e)) return n.push(e), !1;
                        return A;
                      }, s))
                    : 1 === B &&
                      (s = A.reduce(function (A, r) {
        ...
        var Yr,
          qr,
          Zr = function (A) {
            return A.type === sr.LINEAR_GRADIENT;
          },
          jr = function (A) {
            return A.type === sr.RADIAL_GRADIENT;
          };
        (function (A) {
        ...
        var $r = {
          name: "image",
          parse: function (A) {
            if (A.type === w.URL_TOKEN) {
              var e = { url: A.value, type: sr.URL };
              return Tr.getInstance().addImage(A.value), e;
            }
            if (A.type === w.FUNCTION) {
              var t = tn[A.name];
              if ("undefined" === typeof t)
        ...
        function An(A) {
          return A.type !== w.FUNCTION || tn[A.name];
        }
        var en,
          tn = {
            "linear-gradient": Cr,
            "-moz-linear-gradient": gr,
            "-ms-linear-gradient": gr,
            "-o-linear-gradient": gr,
          ...
          rn = {
            ...
            parse: function (A) {
              ...
              var e = A[0];
              return e.type === w.IDENT_TOKEN && "none" === e.value
                ? []
                : A.filter(function (A) {
                    return mt(A) && An(A);
                  }).map($r.parse);
        ...
        var fn,
          ...
          bn = {
            ...
            type: er.LIST,
            parse: function (A) {
              return A.filter(Nt).reduce(function (A, e) {
                return A | Sn(e.value);
              }, 0);
            },
          },
        ...
        var Mn,
            ...
            parse: function (A) {
              switch (A) {
                ...
                case "right":
                  return fn.RIGHT;
                case "inline-start":
                  return fn.INLINE_START;
                case "inline-end":
                  return fn.INLINE_END;
              }
              return fn.NONE;
            },
          },
          _n = {
            ...
            type: er.VALUE,
            parse: function (A) {
              return A.type === w.IDENT_TOKEN && "normal" === A.value
                ? 0
                : A.type === w.NUMBER_TOKEN || A.type === w.DIMENSION_TOKEN
                ? A.number
                : 0;
            },
          };
        ...
        var Pn,
          ...
          zn = function (A, e) {
            return Nt(A) && "normal" === A.value
              ? 1.2 * e
              : A.type === w.NUMBER_TOKEN
              ? e * A.number
              : Dt(A)
              ? _t(A, e)
              : e;
          ...
          Xn = {
            ...
            prefix: !1,
            parse: function (A) {
              return A.type === w.IDENT_TOKEN && "none" === A.value
                ? null
                : $r.parse(A);
            },
          };
            ...
            parse: function (A) {
              switch (A) {
                ...
                case "decimal":
                  return Jn.DECIMAL;
                case "cjk-decimal":
                  return Jn.CJK_DECIMAL;
                case "decimal-leading-zero":
                  return Jn.DECIMAL_LEADING_ZERO;
                case "lower-roman":
                  return Jn.LOWER_ROMAN;
                case "upper-roman":
                  return Jn.UPPER_ROMAN;
                case "lower-greek":
                  return Jn.LOWER_GREEK;
                case "lower-alpha":
                  return Jn.LOWER_ALPHA;
                case "upper-alpha":
                  return Jn.UPPER_ALPHA;
                case "arabic-indic":
                  return Jn.ARABIC_INDIC;
                case "armenian":
                  return Jn.ARMENIAN;
                case "bengali":
                  return Jn.BENGALI;
                ...
                case "cjk-earthly-branch":
                  return Jn.CJK_EARTHLY_BRANCH;
                case "cjk-heavenly-stem":
                  return Jn.CJK_HEAVENLY_STEM;
                case "cjk-ideographic":
                  return Jn.CJK_IDEOGRAPHIC;
                case "devanagari":
                  return Jn.DEVANAGARI;
                case "ethiopic-numeric":
                  return Jn.ETHIOPIC_NUMERIC;
                case "georgian":
                  return Jn.GEORGIAN;
                case "gujarati":
                  return Jn.GUJARATI;
                ...
                case "hiragana":
                  return Jn.HIRAGANA;
                case "hiragana-iroha":
                  return Jn.HIRAGANA_IROHA;
                case "japanese-formal":
                  return Jn.JAPANESE_FORMAL;
                case "japanese-informal":
                  return Jn.JAPANESE_INFORMAL;
                case "kannada":
                  return Jn.KANNADA;
                case "katakana":
                  return Jn.KATAKANA;
                case "katakana-iroha":
                  return Jn.KATAKANA_IROHA;
                case "khmer":
                  return Jn.KHMER;
                case "korean-hangul-formal":
                  return Jn.KOREAN_HANGUL_FORMAL;
                case "korean-hanja-formal":
                  return Jn.KOREAN_HANJA_FORMAL;
                case "korean-hanja-informal":
                  return Jn.KOREAN_HANJA_INFORMAL;
                case "lao":
                  return Jn.LAO;
                case "lower-armenian":
                  return Jn.LOWER_ARMENIAN;
                case "malayalam":
                  return Jn.MALAYALAM;
                case "mongolian":
                  return Jn.MONGOLIAN;
                ...
                case "simp-chinese-formal":
                  return Jn.SIMP_CHINESE_FORMAL;
                case "simp-chinese-informal":
                  return Jn.SIMP_CHINESE_INFORMAL;
                case "tamil":
                  return Jn.TAMIL;
                case "telugu":
                  return Jn.TELUGU;
                ...
                case "trad-chinese-formal":
                  return Jn.TRAD_CHINESE_FORMAL;
                case "trad-chinese-informal":
                  return Jn.TRAD_CHINESE_INFORMAL;
                case "upper-armenian":
                  return Jn.UPPER_ARMENIAN;
                case "disclosure-open":
                  return Jn.DISCLOSURE_OPEN;
                case "disclosure-closed":
                  return Jn.DISCLOSURE_CLOSED;
                case "none":
                default:
                  return Jn.NONE;
              }
        ...
        var AB,
          eB = {
            ...
            type: er.LIST,
            parse: function (A) {
              return A.filter(Nt).map(function (A) {
                switch (A.value) {
                  case "hidden":
                    return kn.HIDDEN;
                  case "scroll":
        ...
        var UB,
          ...
          CB = {
            ...
            type: er.VALUE,
            parse: function (A) {
              if (A.type === w.IDENT_TOKEN && "none" === A.value) return null;
              if (A.type === w.FUNCTION) {
                var e = gB[A.name];
                if ("undefined" === typeof e)
                  throw new Error(
          ...
          EB = { type: w.PERCENTAGE_TOKEN, number: 50, flags: yA },
          FB = [EB, EB],
          hB = {
        ...
        var fB,
          ...
          NB = {
            ...
            type: er.VALUE,
            parse: function (A) {
              if (A.type === w.IDENT_TOKEN) return { auto: !0, order: 0 };
              if (pt(A)) return { auto: !1, order: A.number };
        ...
        var DB,
          ...
          SB = {
            ...
            parse: function (A) {
              if (0 === A.length) return [];
              var e = A[0];
              return e.type === w.IDENT_TOKEN && "none" === e.value ? [] : A;
            },
          },
          MB = {
            ...
            parse: function (A) {
              ...
              var e = A[0];
              if (e.type === w.IDENT_TOKEN && "none" === e.value) return null;
              for (var t = [], r = A.filter(Tt), n = 0; n < r.length; n++) {
                var B = r[n],
                  s = r[n + 1];
                if (B.type === w.IDENT_TOKEN) {
                  var o = s && pt(s) ? s.number : 1;
          ...
          yB = {
            ...
            parse: function (A) {
              if (0 === A.length) return [];
              for (var e = [], t = A.filter(Tt), r = 0; r < t.length; r++) {
                var n = t[r],
                  B = t[r + 1];
                if (Nt(n) && "none" !== n.value) {
                  var s = B && pt(B) ? B.number : 0;
          ...
          VB = (function () {
            function A(A) {
              (this.backgroundClip = JB(or, A.backgroundClip)),
                (this.backgroundColor = JB(ir, A.backgroundColor)),
                (this.backgroundImage = JB(rn, A.backgroundImage)),
                (this.backgroundOrigin = JB(nn, A.backgroundOrigin)),
                (this.backgroundPosition = JB(Bn, A.backgroundPosition)),
                (this.backgroundRepeat = JB(on, A.backgroundRepeat)),
                (this.backgroundSize = JB(Qn, A.backgroundSize)),
                (this.borderTopColor = JB(Un, A.borderTopColor)),
                (this.borderRightColor = JB(ln, A.borderRightColor)),
                (this.borderBottomColor = JB(Cn, A.borderBottomColor)),
                (this.borderLeftColor = JB(gn, A.borderLeftColor)),
                (this.borderTopLeftRadius = JB(Fn, A.borderTopLeftRadius)),
                (this.borderTopRightRadius = JB(hn, A.borderTopRightRadius)),
                (this.borderBottomRightRadius = JB(
                  Hn,
                  A.borderBottomRightRadius
                )),
                (this.borderBottomLeftRadius = JB(
                  dn,
                  A.borderBottomLeftRadius
                )),
                (this.borderTopStyle = JB(Nn, A.borderTopStyle)),
                (this.borderRightStyle = JB(Kn, A.borderRightStyle)),
                (this.borderBottomStyle = JB(In, A.borderBottomStyle)),
                (this.borderLeftStyle = JB(Tn, A.borderLeftStyle)),
                (this.borderTopWidth = JB(Rn, A.borderTopWidth)),
                (this.borderRightWidth = JB(Ln, A.borderRightWidth)),
                (this.borderBottomWidth = JB(On, A.borderBottomWidth)),
                (this.borderLeftWidth = JB(Dn, A.borderLeftWidth)),
                (this.boxShadow = JB(xB, A.boxShadow)),
                (this.color = JB(vn, A.color)),
                (this.display = JB(bn, A.display)),
                (this.float = JB(yn, A.cssFloat)),
                (this.fontFamily = JB(mB, A.fontFamily)),
                (this.fontSize = JB(RB, A.fontSize)),
                (this.fontStyle = JB(vB, A.fontStyle)),
                (this.fontVariant = JB(OB, A.fontVariant)),
                (this.fontWeight = JB(LB, A.fontWeight)),
                (this.letterSpacing = JB(_n, A.letterSpacing)),
                (this.lineBreak = JB(xn, A.lineBreak)),
                (this.lineHeight = JB(Vn, A.lineHeight)),
                (this.listStyleImage = JB(Xn, A.listStyleImage)),
                (this.listStylePosition = JB(Gn, A.listStylePosition)),
                (this.listStyleType = JB(Wn, A.listStyleType)),
                (this.marginTop = JB(qn, A.marginTop)),
                (this.marginRight = JB(Zn, A.marginRight)),
                (this.marginBottom = JB(jn, A.marginBottom)),
                (this.marginLeft = JB($n, A.marginLeft)),
                (this.opacity = JB(KB, A.opacity));
              var e = JB(eB, A.overflow);
              (this.overflowX = e[0]),
                (this.overflowY = e[e.length > 1 ? 1 : 0]),
                (this.overflowWrap = JB(rB, A.overflowWrap)),
                (this.paddingTop = JB(BB, A.paddingTop)),
                (this.paddingRight = JB(sB, A.paddingRight)),
                (this.paddingBottom = JB(oB, A.paddingBottom)),
                (this.paddingLeft = JB(iB, A.paddingLeft)),
                (this.position = JB(uB, A.position)),
                (this.textAlign = JB(cB, A.textAlign)),
                (this.textDecorationColor = JB(
                  IB,
                  A.textDecorationColor || A.color
                )),
                (this.textDecorationLine = JB(TB, A.textDecorationLine)),
                (this.textShadow = JB(wB, A.textShadow)),
                (this.textTransform = JB(lB, A.textTransform)),
                (this.transform = JB(CB, A.transform)),
                (this.transformOrigin = JB(hB, A.transformOrigin)),
                (this.visibility = JB(dB, A.visibility)),
                (this.wordBreak = JB(pB, A.wordBreak)),
                (this.zIndex = JB(NB, A.zIndex));
            }
            return (
              ...
              (A.prototype.isPositioned = function () {
                return this.position !== aB.STATIC;
              }),
              (A.prototype.isPositionedWithZIndex = function () {
                return this.isPositioned() && !this.zIndex.auto;
              }),
              (A.prototype.isFloating = function () {
                return this.float !== fn.NONE;
              }),
              (A.prototype.isInlineLevel = function () {
                return (
                  bB(this.display, 4) ||
                  bB(this.display, 33554432) ||
                  bB(this.display, 268435456) ||
                  bB(this.display, 536870912) ||
                  bB(this.display, 67108864) ||
                  bB(this.display, 134217728)
                );
              }),
              A
            );
          ...
          zB = (function () {
            function A(A) {
              (this.content = JB(SB, A.content)),
                (this.quotes = JB(_B, A.quotes));
            }
            return A;
          })(),
          XB = (function () {
            function A(A) {
              (this.counterIncrement = JB(MB, A.counterIncrement)),
                (this.counterReset = JB(yB, A.counterReset));
            }
            return A;
          })(),
          JB = function (A, e) {
            ...
            switch (A.type) {
              case er.IDENT_VALUE:
                ...
                return A.parse(Nt(B) ? B.value : A.initialValue);
              case er.VALUE:
              ...
              case er.TYPE_VALUE:
                switch (A.format) {
                  case "angle":
                    return Xt.parse(n.parseComponentValue());
                  case "color":
                    return Wt.parse(n.parseComponentValue());
                  case "image":
                    return $r.parse(n.parseComponentValue());
                  case "length":
          ...
          GB = (function () {
            function A(A) {
              (this.styles = new VB(window.getComputedStyle(A, null))),
                (this.textNodes = []),
                (this.elements = []),
              ...
              r.forEach(function (A) {
                if (e.textDecorationLine.length || A.trim().length > 0)
                  if (Kr.SUPPORT_RANGE_BOUNDS)
                    n.push(new kB(A, qB(t, B, A.length)));
                  else {
                    var r = t.splitText(A.length);
                    n.push(new kB(A, YB(t))), (t = r);
                  }
                else Kr.SUPPORT_RANGE_BOUNDS || (t = t.splitText(A.length));
                B += A.length;
              }),
              n
            );
          ...
          $B = (function () {
            function A(A, e) {
              (this.text = As(A.data, e.textTransform)),
                (this.textBounds = WB(this.text, e, A));
            }
            return A;
          })(),
          As = function (A, e) {
          ...
          is = [{ type: w.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3 }],
          as = [{ type: w.PERCENTAGE_TOKEN, flags: 0, number: 50 }],
          cs = function (A) {
              ...
              switch (
                ...
                (t.type !== us && t.type !== ws) ||
                  ...
                  (t.styles.borderTopStyle = t.styles.borderRightStyle = t.styles.borderBottomStyle = t.styles.borderLeftStyle =
                    cn.SOLID),
                  (t.styles.backgroundClip = [tr.BORDER_BOX]),
                  (t.styles.backgroundOrigin = [0]),
                  (t.bounds = cs(t.bounds))),
                t.type)
              ) {
                case us:
                  t.styles.borderTopRightRadius = t.styles.borderTopLeftRadius = t.styles.borderBottomRightRadius = t.styles.borderBottomLeftRadius = is;
                  break;
                case ws:
                  t.styles.borderTopRightRadius = t.styles.borderTopLeftRadius = t.styles.borderBottomRightRadius = t.styles.borderBottomLeftRadius = as;
              }
              return t;
            }
            return e(t, A), t;
          ...
          Fs = function (A) {
            return Wt.parse(dt.create(A).parseComponentValue());
          },
          hs = (function (A) {
            function t(e) {
              var t = A.call(this, e) || this;
              ...
              try {
                if (
                  ...
                  t.tree = ps(e.contentWindow.document.documentElement);
          ...
          ds = function A(e, t, r) {
            for (var n = e.firstChild, B = void 0; n; n = B)
              if (((B = n.nextSibling), Is(n) && n.data.trim().length > 0))
                t.textNodes.push(new $B(n, t.styles));
              else if (Ts(n)) {
                var s = fs(n);
                s.styles.isVisible() &&
                  (Ns(n, s, r)
                    ? (s.flags |= 4)
                    : Ks(s.styles) && (s.flags |= 2),
                  -1 !== Hs.indexOf(n.tagName) && (s.flags |= 8),
                  t.elements.push(s),
                  Vs(n) || bs(n) || zs(n) || A(n, s, r));
              }
          },
          fs = function (A) {
            return ys(A)
          ...
          ms = function (A) {
            return Ts(A) && "undefined" !== typeof A.style && !Rs(A);
          },
          Rs = function (A) {
          ...
          Zs = function (A, e, t, r, n) {
            var B = t - e + 1;
            return (
              (A < 0 ? "-" : "") +
              (qs(Math.abs(A), B, r, function (A) {
                return a(Math.floor(A % B) + e);
              }) +
                n)
            );
          },
          ...
          eo = 4,
          to = 8,
          ro = function (A, e, t, r, n, B) {
            if (A < -9999 || A > 9999)
              return io(A, Jn.CJK_DECIMAL, n.length > 0);
            var s = Math.abs(A),
              o = n;
            if (0 === s) return e[0] + o;
          ...
          io = function (A, e, t) {
            ...
            switch (e) {
              ...
              case Jn.SQUARE:
                return "\u25fe" + s;
              case Jn.DECIMAL_LEADING_ZERO:
                var o = Zs(A, 48, 57, !0, r);
              ...
              case Jn.LOWER_ROMAN:
                return Ys(A, 1, 3999, Js, Jn.DECIMAL, r).toLowerCase();
              case Jn.UPPER_ROMAN:
                return Ys(A, 1, 3999, Js, Jn.DECIMAL, r);
              case Jn.LOWER_GREEK:
                return Zs(A, 945, 969, !1, r);
              case Jn.LOWER_ALPHA:
                return Zs(A, 97, 122, !1, r);
              case Jn.UPPER_ALPHA:
                return Zs(A, 65, 90, !1, r);
              case Jn.ARABIC_INDIC:
                return Zs(A, 1632, 1641, !0, r);
              case Jn.ARMENIAN:
              case Jn.UPPER_ARMENIAN:
                return Ys(A, 1, 9999, Gs, Jn.DECIMAL, r);
              case Jn.LOWER_ARMENIAN:
                return Ys(A, 1, 9999, Gs, Jn.DECIMAL, r).toLowerCase();
              case Jn.BENGALI:
                return Zs(A, 2534, 2543, !0, r);
              case Jn.CAMBODIAN:
              case Jn.KHMER:
                return Zs(A, 6112, 6121, !0, r);
              case Jn.CJK_EARTHLY_BRANCH:
                return js(
                  A,
                  "\u5b50\u4e11\u5bc5\u536f\u8fb0\u5df3\u5348\u672a\u7533\u9149\u620c\u4ea5",
                  n
                );
              case Jn.CJK_HEAVENLY_STEM:
                return js(
                  A,
                  "\u7532\u4e59\u4e19\u4e01\u620a\u5df1\u5e9a\u8f9b\u58ec\u7678",
                  n
                );
              case Jn.CJK_IDEOGRAPHIC:
              case Jn.TRAD_CHINESE_INFORMAL:
                return ro(
                  A,
                  "\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",
                  no,
              ...
              case Jn.DEVANAGARI:
                return Zs(A, 2406, 2415, !0, r);
              case Jn.GEORGIAN:
                return Ys(A, 1, 19999, Ws, Jn.DECIMAL, r);
              case Jn.GUJARATI:
                return Zs(A, 2790, 2799, !0, r);
              case Jn.GURMUKHI:
                return Zs(A, 2662, 2671, !0, r);
              case Jn.HEBREW:
                return Ys(A, 1, 10999, ks, Jn.DECIMAL, r);
              case Jn.HIRAGANA:
                return js(
                  A,
                  "\u3042\u3044\u3046\u3048\u304a\u304b\u304d\u304f\u3051\u3053\u3055\u3057\u3059\u305b\u305d\u305f\u3061\u3064\u3066\u3068\u306a\u306b\u306c\u306d\u306e\u306f\u3072\u3075\u3078\u307b\u307e\u307f\u3080\u3081\u3082\u3084\u3086\u3088\u3089\u308a\u308b\u308c\u308d\u308f\u3090\u3091\u3092\u3093"
                );
              case Jn.HIRAGANA_IROHA:
                return js(
                  A,
                  "\u3044\u308d\u306f\u306b\u307b\u3078\u3068\u3061\u308a\u306c\u308b\u3092\u308f\u304b\u3088\u305f\u308c\u305d\u3064\u306d\u306a\u3089\u3080\u3046\u3090\u306e\u304a\u304f\u3084\u307e\u3051\u3075\u3053\u3048\u3066\u3042\u3055\u304d\u3086\u3081\u307f\u3057\u3091\u3072\u3082\u305b\u3059"
                );
              case Jn.KANNADA:
                return Zs(A, 3302, 3311, !0, r);
              case Jn.KATAKANA:
                return js(
                  A,
              ...
              case Jn.LAO:
                return Zs(A, 3792, 3801, !0, r);
              case Jn.MONGOLIAN:
                return Zs(A, 6160, 6169, !0, r);
              case Jn.MYANMAR:
                return Zs(A, 4160, 4169, !0, r);
              case Jn.ORIYA:
                return Zs(A, 2918, 2927, !0, r);
              case Jn.PERSIAN:
                return Zs(A, 1776, 1785, !0, r);
              case Jn.TAMIL:
                return Zs(A, 3046, 3055, !0, r);
              case Jn.TELUGU:
                return Zs(A, 3174, 3183, !0, r);
              case Jn.THAI:
                return Zs(A, 3664, 3673, !0, r);
              case Jn.TIBETAN:
                return Zs(A, 3872, 3881, !0, r);
              case Jn.DECIMAL:
              default:
                return Zs(A, 48, 57, !0, r);
            }
          },
          ...
          co = (function () {
            ...
            return (
              (A.prototype.toIFrame = function (A, e) {
                    ...
                    return r(t, void 0, void 0, function () {
                      ...
                      return n(this, function (t) {
                        switch (t.label) {
                          case 0:
                            return (
                              this.scrolledElements.forEach(go),
                              i &&
                                ...
                                !/(iPad|iPhone|iPod)/g.test(
                                  ...
                                  (i.scrollY === e.top &&
                                    i.scrollX === e.left) ||
                                  ((a.documentElement.style.top =
                                    -e.top + "px"),
                                  (a.documentElement.style.left =
                                    -e.left + "px"),
                                  (a.documentElement.style.position =
                                    "absolute"))),
                ...
                return (
                  a.open(),
                  a.write(lo(document.doctype) + "<html></html>"),
                  Co(this.referenceElement.ownerDocument, s, o),
                  a.replaceChild(
              ...
              (A.prototype.createElementClone = function (A) {
                if (Ms(A)) return this.createCanvasClone(A);
                if (Ps(A)) return this.createStyleClone(A);
                var e = A.cloneNode(!1);
                return (
                  ys(e) && "lazy" === e.loading && (e.loading = "eager"), e
                );
              }),
              (A.prototype.createStyleClone = function (A) {
                try {
                  ...
                  if (
                    (Ir.getInstance(this.options.id).error(
                      "Unable to access cssRules property",
                      Re
                    ),
                    "SecurityError" !== Re.name)
                  )
                    throw Re;
                }
              ...
              (A.prototype.createCanvasClone = function (A) {
                if (this.options.inlineImages && A.ownerDocument) {
                  ...
                  try {
                    ...
                    Ir.getInstance(this.options.id).info(
              ...
              (A.prototype.cloneNode = function (A) {
                if (Is(A)) return document.createTextNode(A.data);
                ...
                if (e && Ts(A) && (ms(A) || Rs(A))) {
                  ...
                  this.referenceElement === A &&
                    ...
                    Ss(t) && po(t);
                  for (
                    var s = this.counters.parse(new XB(r)),
                      o = this.resolvePseudoContent(A, t, n, DB.BEFORE),
                      i = A.firstChild;
                    i;
                    i = i.nextSibling
                  )
                    (Ts(i) &&
                      ...
                      (this.options.copyStyles && Ts(i) && Ps(i)) ||
                  ...
                  return (
                    ...
                    (Vs(A) || zs(A)) && (Vs(t) || zs(t)) && (t.value = A.value),
                    t
                  );
                }
                return A.cloneNode(!1);
                ...
                if (t) {
                  ...
                  if (
                    ...
                    Uo(t, i),
                      o.content.forEach(function (e) {
                        if (e.type === w.STRING_TOKEN)
                          ...
                          if ("attr" === e.name) {
                            ...
                            var B = e.values.filter(mt),
                              a = B[0],
                              c = B[1];
                            if (a && Nt(a)) {
                              var Q = n.counters.getCounterValue(a.value),
                                u = c && Nt(c) ? Wn.parse(c.value) : Jn.DECIMAL;
                              i.appendChild(s.createTextNode(io(Q, u, !1)));
                            }
                          } else if ("counters" === e.name) {
                            var U = e.values.filter(mt),
                              l = ((a = U[0]), U[1]);
                            if (((c = U[2]), a && Nt(a))) {
                              var C = n.counters.getCounterValues(a.value),
                                g = c && Nt(c) ? Wn.parse(c.value) : Jn.DECIMAL,
                                E =
                                  l && l.type === w.STRING_TOKEN ? l.value : "",
                                F = C.map(function (A) {
                                  return io(A, g, !1);
                                }).join(E);
                        ...
                        } else if (e.type === w.IDENT_TOKEN)
                          switch (e.value) {
                            case "open-quote":
                              i.appendChild(
                                s.createTextNode(
                                  PB(o.quotes, n.quoteDepth++, !0)
                                )
                              );
                              break;
                            case "close-quote":
                      ...
                      (i.className = ho + " " + Ho);
                    var a = r === DB.BEFORE ? " " + ho : " " + Ho;
                    return (
                      Rs(e) ? (e.className.baseValue += a) : (e.className += a),
                      i
                    );
                  }
                }
        ...
        var Ko,
          ...
          mo = (function () {
            function A(A, e) {
              (this.type = Qo.VECTOR), (this.x = A), (this.y = e);
            }
            return (
          ...
          Lo = (function () {
            ...
            return (
              (A.prototype.subdivide = function (e, t) {
                var r = Ro(this.start, this.startControl, e),
                  n = Ro(this.startControl, this.endControl, e),
                  B = Ro(this.endControl, this.end, e),
                  s = Ro(r, n, e),
                  o = Ro(n, B, e),
                  i = Ro(s, o, e);
                return t
          ...
          Oo = function (A) {
            return A.type === Qo.BEZIER_CURVE;
          },
          Do = (function () {
            function A(A) {
              var e = A.styles,
                t = A.bounds,
                r = yt(e.borderTopLeftRadius, t.width, t.height),
                n = r[0],
                B = r[1],
                s = yt(e.borderTopRightRadius, t.width, t.height),
                o = s[0],
                i = s[1],
                a = yt(e.borderBottomRightRadius, t.width, t.height),
                c = a[0],
                Q = a[1],
                u = yt(e.borderBottomLeftRadius, t.width, t.height),
                w = u[0],
                U = u[1],
                l = [];
              l.push((n + o) / t.width),
              ...
              var g = t.width - o,
                ...
                p = e.borderLeftWidth,
                N = _t(e.paddingTop, A.bounds.width),
                K = _t(e.paddingRight, A.bounds.width),
                I = _t(e.paddingBottom, A.bounds.width),
                T = _t(e.paddingLeft, A.bounds.width);
              (this.topLeftBorderBox =
                n > 0 || B > 0
                  ? vo(t.left, t.top, n, B, Ko.TOP_LEFT)
                  : new mo(t.left, t.top)),
                (this.topRightBorderBox =
                  o > 0 || i > 0
                    ? vo(t.left + g, t.top, o, i, Ko.TOP_RIGHT)
                    : new mo(t.left + t.width, t.top)),
                (this.bottomRightBorderBox =
                  c > 0 || Q > 0
                    ? vo(t.left + F, t.top + E, c, Q, Ko.BOTTOM_RIGHT)
                    : new mo(t.left + t.width, t.top + t.height)),
                (this.bottomLeftBorderBox =
                  w > 0 || U > 0
                    ? vo(t.left, t.top + h, w, U, Ko.BOTTOM_LEFT)
                    : new mo(t.left, t.top + t.height)),
                ...
                (this.topRightPaddingBox =
                  o > 0 || i > 0
                    ...
                    : new mo(t.left + t.width - d, t.top + H)),
                (this.bottomRightPaddingBox =
                  c > 0 || Q > 0
                    ...
                    : new mo(t.left + t.width - d, t.top + t.height - f)),
                (this.bottomLeftPaddingBox =
                  w > 0 || U > 0
                    ...
                    : new mo(t.left + p, t.top + t.height - f)),
                ...
                (this.topRightContentBox =
                  o > 0 || i > 0
                    ...
                    : new mo(t.left + t.width - (d + K), t.top + H + N)),
                ...
                (this.bottomLeftContentBox =
                  w > 0 || U > 0
                    ...
                    : new mo(t.left + p + T, t.top + t.height - (f + I)));
            }
            return A;
          })();
        !(function (A) {
        ...
        var vo = function (A, e, t, r, n) {
          ...
          zo = (function () {
            function A(A, e) {
              if (
                ...
                this.effects.push(new yo(t, r, n));
              }
              if (A.styles.overflowX !== kn.VISIBLE) {
                var B = bo(this.curves),
                  s = Mo(this.curves);
                Io(B, s)
                  ? this.effects.push(new _o(B, 6))
                  : (this.effects.push(new _o(B, 2)),
                    this.effects.push(new _o(s, 4)));
              }
            }
            return (
              (A.prototype.getParentEffects = function () {
                var A = this.effects.slice(0);
                if (this.container.styles.overflowX !== kn.VISIBLE) {
                  var e = bo(this.curves),
                    t = Mo(this.curves);
                  Io(e, t) || A.push(new _o(t, 6));
                }
                return A;
              }),
              A
          ...
          Xo = function A(e, t, r, n) {
            e.container.elements.forEach(function (B) {
              var s = bB(B.flags, 4),
                o = bB(B.flags, 2),
                i = new zo(B, e.getParentEffects());
              bB(B.styles.display, 2048) && n.push(i);
              var a = bB(B.flags, 8) ? [] : n;
              if (s || o) {
                ...
                if (
                  ...
                  if (u < 0) {
                    ...
                    c.negativeZIndex.some(function (A, e) {
                      return u > A.element.container.styles.zIndex.order
                        ? ((w = e), !1)
                        : w > 0;
                    }),
                ...
                A(i, Q, s ? Q : r, a);
              } else B.styles.isInlineLevel() ? t.inlineLevel.push(i) : t.nonInlineLevel.push(i), A(i, t, r, a);
              bB(B.flags, 8) && Jo(B, a);
            });
          },
          Jo = function (A, e) {
            for (
              var t = A instanceof os ? A.start : 1,
                r = A instanceof os && A.reversed,
                n = 0;
              n < e.length;
              n++
            ) {
              var B = e[n];
              B.container instanceof ss &&
                "number" === typeof B.container.value &&
                0 !== B.container.value &&
                (t = B.container.value),
                (B.listValue = io(t, B.container.styles.listStyleType, !0)),
                (t += r ? -1 : 1);
            }
          },
          Go = function (A) {
            var e = new zo(A, []),
              t = new Vo(e),
              r = [];
            return Xo(e, t, t, r), Jo(e.container, r), t;
          },
          ko = function (A, e) {
            switch (e) {
              case 0:
          ...
          Wo = function (A, e, t, r) {
            var n = [];
            return (
              Oo(A) ? n.push(A.subdivide(0.5, !1)) : n.push(A),
              Oo(t) ? n.push(t.subdivide(0.5, !0)) : n.push(t),
              Oo(r) ? n.push(r.subdivide(0.5, !0).reverse()) : n.push(r),
              Oo(e) ? n.push(e.subdivide(0.5, !1).reverse()) : n.push(e),
              n
            );
          },
          Yo = function (A) {
          ...
          qo = function (A) {
            var e = A.styles,
              t = A.bounds,
              r = _t(e.paddingLeft, t.width),
              n = _t(e.paddingRight, t.width),
              B = _t(e.paddingTop, t.width),
              s = _t(e.paddingBottom, t.width);
            return t.add(
              r + e.borderLeftWidth,
              B + e.borderTopWidth,
          ...
          Zo = function (A, e) {
            return 0 === A ? e.bounds : 2 === A ? qo(e) : Yo(e);
          },
          jo = function (A, e) {
            return A === tr.BORDER_BOX
              ? e.bounds
              : A === tr.CONTENT_BOX
              ? qo(e)
              : Yo(e);
          ...
          $o = function (A, e, t) {
            var r = Zo(ri(A.styles.backgroundOrigin, e), A),
              n = jo(ri(A.styles.backgroundClip, e), A),
              B = ti(ri(A.styles.backgroundSize, e), t, r),
              s = B[0],
              o = B[1],
              i = yt(
                ri(A.styles.backgroundPosition, e),
                r.width - s,
                r.height - o
              );
            return [
              ni(ri(A.styles.backgroundRepeat, e), i, B, r, n),
          ...
          ti = function (A, e, t) {
            var r = e[0],
              ...
              s = A[0],
              o = A[1];
            if (Dt(s) && o && Dt(o)) return [_t(s, t.width), _t(o, t.height)];
            var i = ei(B);
            if (Nt(s) && (s.value === sn.CONTAIN || s.value === sn.COVER))
              return ei(B)
                ? t.width / t.height < B !== (s.value === sn.COVER)
                  ? [t.width, t.width / B]
                  : [t.height * B, t.height]
                : [t.width, t.height];
            var a = ei(r),
            ...
            if (i) {
              var u = 0,
                w = 0;
              return (
                Dt(s) ? (u = _t(s, t.width)) : Dt(o) && (w = _t(o, t.height)),
                Ai(s) ? (u = w * B) : (o && !Ai(o)) || (w = u / B),
                [u, w]
              );
            }
            var U = null,
            ...
            if (
              (Dt(s)
                ? (U = _t(s, t.width))
                : o && Dt(o) && (l = _t(o, t.height)),
              null === U ||
                (o && !Ai(o)) ||
                (l = a && c ? (U / r) * n : t.height),
              null !== l && Ai(s) && (U = a && c ? (l / n) * r : t.width),
              null !== U && null !== l)
            )
              return [U, l];
          ...
          ni = function (A, e, t, r, n) {
            ...
            switch (A) {
              case en.REPEAT_X:
                return [
                  new mo(Math.round(r.left), Math.round(r.top + s)),
                  new mo(Math.round(r.left + r.width), Math.round(r.top + s)),
                  new mo(
                    Math.round(r.left + r.width),
                    Math.round(i + r.top + s)
                  ),
                  new mo(Math.round(r.left), Math.round(i + r.top + s)),
                ];
              case en.REPEAT_Y:
                return [
                  new mo(Math.round(r.left + B), Math.round(r.top)),
                  new mo(Math.round(r.left + B + o), Math.round(r.top)),
                  new mo(
                    Math.round(r.left + B + o),
                    Math.round(r.height + r.top)
                  ),
                  new mo(Math.round(r.left + B), Math.round(r.height + r.top)),
                ];
              case en.NO_REPEAT:
                return [
                  new mo(Math.round(r.left + B), Math.round(r.top + s)),
                  new mo(Math.round(r.left + B + o), Math.round(r.top + s)),
                  new mo(Math.round(r.left + B + o), Math.round(r.top + s + i)),
                  new mo(Math.round(r.left + B), Math.round(r.top + s + i)),
                ];
              default:
                return [
                  new mo(Math.round(n.left), Math.round(n.top)),
                  new mo(Math.round(n.left + n.width), Math.round(n.top)),
                  new mo(
                    Math.round(n.left + n.width),
                    Math.round(n.height + n.top)
                  ),
                  new mo(Math.round(n.left), Math.round(n.height + n.top)),
                ];
            }
          },
          Bi =
            ...
            return (
              (A.prototype.parseMetrics = function (A, e) {
                ...
                (t.style.visibility = "hidden"),
                  ...
                  (n.style.margin = "0"),
                  (n.style.padding = "0"),
                  n.appendChild(this._document.createTextNode(si)),
                  t.appendChild(n),
                  t.appendChild(r);
                var s = r.offsetTop - n.offsetTop + 2;
                t.removeChild(n),
                  t.appendChild(this._document.createTextNode(si)),
          ...
          ai = (function () {
            ...
            return (
              ...
              (A.prototype.applyEffect = function (A) {
                this.ctx.save(),
                  Po(A) &&
                    ...
                    this.ctx.translate(-A.offsetX, -A.offsetY)),
                  xo(A) && (this.path(A.path), this.ctx.clip()),
              ...
              (A.prototype.renderNodeContent = function (e) {
                return r(this, void 0, void 0, function () {
                  var t, r, s, o, i, a, c, Q, u, w, U, l, C, g;
                  return n(this, function (n) {
                    switch (n.label) {
                      case 0:
                      ...
                      case 6:
                        return (
                          (l = n.sent()),
                          this.renderReplacedElement(t, r, l),
                          [3, 8]
                        );
                      case 7:
                        return (
                      ...
                      case 14:
                        if (
                          ...
                          switch (
                            ...
                            (this.ctx.fillStyle = qt(s.color)),
                            (this.ctx.textBaseline = "middle"),
                            (this.ctx.textAlign = ui(t.styles.textAlign)),
                            (g = qo(t)),
                            (u = 0),
                            t.styles.textAlign)
                          ) {
                          ...
                          (w = g.add(u, 0, 0, -g.height / 2 + 1)),
                            this.ctx.save(),
                            this.path([
                              new mo(g.left, g.top),
                              new mo(g.left + g.width, g.top),
                              new mo(g.left + g.width, g.top + g.height),
                              new mo(g.left, g.top + g.height),
                            ]),
                            this.ctx.clip(),
                        ...
                        if (!bB(t.styles.display, 2048)) return [3, 20];
                        if (null === t.styles.listStyleImage) return [3, 19];
                        if ((U = t.styles.listStyleImage).type !== sr.URL)
                          return [3, 18];
                        (l = void 0), (C = U.url), (n.label = 15);
                      case 15:
                        return (
                          n.trys.push([15, 17, , 18]),
                          [4, this.options.cache.match(C)]
                        );
                      case 16:
                        return (
                          (l = n.sent()),
                      ...
                      case 19:
                        e.listValue &&
                          t.styles.listStyleType !== Jn.NONE &&
                          ((this.ctx.font = this.createFontStyle(s)[0]),
                          (this.ctx.fillStyle = qt(s.color)),
                          (this.ctx.textBaseline = "middle"),
                          ...
                          (g = new B(
                            t.bounds.left,
                            t.bounds.top +
                              _t(t.styles.paddingTop, t.bounds.width),
                            t.bounds.width,
                            zn(s.lineHeight, s.fontSize.number) / 2 + 1
                          )),
                          this.renderTextWithLetterSpacing(
                            new kB(e.listValue, g),
                            s.letterSpacing
                          ),
                          (this.ctx.textBaseline = "bottom"),
                          (this.ctx.textAlign = "left")),
                            ...
                            return n(this, function (n) {
                              switch (n.label) {
                                ...
                                case 3:
                                  return (
                                    n.sent(),
                                    Ir.getInstance(r.options.id).error(
                                ...
                                case 5:
                                  Zr(t)
                                    ? ((i = $o(A, e, [null, null, null])),
                                      ...
                                      cr(t.stops, c).forEach(function (A) {
                                    ...
                                    : jr(t) &&
                                      ...
                                      m > 0 &&
                                        ...
                                        cr(t.stops, 2 * m).forEach(function (
                                          A
                                        ) {
                    ...
                    switch (n.label) {
                      case 0:
                        return (
                          ...
                          (B = Qi(ri(e.backgroundClip, 0), A.curves)),
                          t || e.boxShadow.length
                            ? (this.ctx.save(),
                              this.path(B),
                              this.ctx.clip(),
                              Yt(e.backgroundColor) ||
                                ((this.ctx.fillStyle = qt(e.backgroundColor)),
                                this.ctx.fill()),
                      ...
                      case 3:
                        return o < i.length
                          ? (a = i[o]).style === cn.NONE || Yt(a.color)
                            ? [3, 5]
          ...
          ci = function (A) {
            return (
              A instanceof Es ||
              A instanceof gs ||
              (A instanceof Cs && A.type !== ws && A.type !== us)
            );
          },
          Qi = function (A, e) {
            switch (A) {
          ...
          gi = function (A, e) {
            return void 0 === e && (e = {}), Ei(A, e);
          };
        "undefined" !== typeof window && Tr.setContext(window);
        var Ei = function (A, e) {
          return r(li, void 0, void 0, function () {
            var r,
              i,
              a,
              c,
              ...
              switch (n.label) {
                case 0:
                  ...
                  return (
                    ...
                    (C = {
                      ...
                      cache: e.cache ? e.cache : Tr.create(a, l),
                      logging: !0,
                      removeContainer: !0,
                    ...
                    Ir.create({ id: a, enabled: g.logging }),
                    Ir.getInstance(a).debug("Starting document clone"),
                    (F = new co(A, {
                      id: a,
                      onclone: g.onclone,
                ...
                case 1:
                  return (
                    (H = n.sent()),
                    (d = r.documentElement
                      ? Ci(getComputedStyle(r.documentElement).backgroundColor)
                      : Br.TRANSPARENT),
                    (f = r.body
                      ? Ci(getComputedStyle(r.body).backgroundColor)
                      : Br.TRANSPARENT),
                    (p = e.backgroundColor),
                    (N =
                      "string" === typeof p
                ...
                case 3:
                  return (
                    ...
                    Tr.attachInstance(g.cache),
                    Ir.getInstance(a).debug("Starting DOM parsing"),
                    (m = ps(h)),
                    Tr.detachInstance(),
                    K === m.styles.backgroundColor &&
                      (m.styles.backgroundColor = Br.TRANSPARENT),
                    Ir.getInstance(a).debug("Starting renderer"),
                    [4, new ai(I).render(m)]
                  );
                case 4:
                  (T = n.sent()), (n.label = 5);
                case 5:
                  return (
                    ...
                    Ir.getInstance(a).debug("Finished rendering"),
                    Ir.destroy(a),
                    Tr.destroy(a),
                    [2, T]
                  );
...
//# sourceMappingURL=5.33b16bf9.chunk.js.map
